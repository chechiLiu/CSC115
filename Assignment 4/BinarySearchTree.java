...
public class BinarySearchTree<E extends Comparable<E>> extends BinaryTree<E> {
	...
	//This method finds the item that is equivalent to the key and removes it, if it's in the tree.
	...
	//This method inserts a new item into the tree, maintaining its order. If the item already exists in the tree, nothing happens.
	...
	//This method Looks for the item in the tree that is equivalent to the key.
	...
	//of traversing the tree in order and placing items into the list.
