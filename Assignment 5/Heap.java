...
public class Heap {
    ...
    //This method returns true if the heap is empty, false if it is not.
	...
	//This method inserts an item into the heap.
	...
	//This method removes the item at the root node of the heap and returns
	...
	//This method retrieves, without removing the item in the root.
    ...
    //This method doubles the heap if the current one is full.
    ...
    //This method moves the new item upto the root of the correct place.
    private void moveUp() {
        int position = size - 1;
        int parent;
    ...
    //This method moves down the item at root upto the leaf until its correct place.
